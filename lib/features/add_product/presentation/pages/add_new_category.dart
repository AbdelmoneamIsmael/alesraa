...
import 'package:e_commerce/features/add_product/presentation/cubit/select_category_cubit/cubit/select_category_cubit_cubit.dart';
...
class _AddNewCategoryState extends State<AddNewCategory> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: BlocProvider(
        create: (context) => SelectCategoryCubitCubit(context: context),
        child: BlocConsumer<SelectCategoryCubitCubit, SelectCategoryCubitState>(
          builder: (context, state) {
            SelectCategoryCubitCubit cubit =
                BlocProvider.of<SelectCategoryCubitCubit>(context);
            return Stack(
              children: [
                Column(
